📘 Practical 12 – Metropolis Algorithm & Deterministic Model ⭐ Aim
...
🧩 Part A – Metropolis Algorithm 🔹 What is the Metropolis Algorithm?
...
Standard Normal Distribution: π(x) ∝ exp(−x² / 2)
...
🧩 Part B – Deterministic Model 🔹 What is a Deterministic Model?
...
🔄 Comparison Method Estimated E[X²] Type Metropolis Algorithm ~1.0006 Stochastic Deterministic Model ~0.9999 Deterministic True Value 1.0 Analytical

Both methods closely match the theoretical value.

📌 Advantages (Short) Metropolis Algorithm

✔ Works for complex/high-dimensional distributions ✔ No need for normalized density ✘ Needs tuning & convergence checks ✘ Contains sampling noise

Deterministic Model

✔ Same output every run ✔ Very accurate in low dimensions ✘ Not practical for high dimensions ✘ Requires good grid selection
